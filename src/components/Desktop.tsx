...
import { Trash2, Globe, Terminal, Settings, HelpCircle, Home, LayoutGrid, Edit3 } from 'lucide-react';
...
const defaultIcons: DesktopIcon[] = [
  ...
  { id: 'd-editor', label: 'Notes', icon: Edit3, appId: 'stickynotes', x: 24, y: 540 },
